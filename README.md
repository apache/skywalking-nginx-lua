...
- **inject**, `require("skywalking.tracer"):inject(exitSpan, correlation)`. Inject an exit span context and correlation context into carrier, and then they will be propagated to the downstream service. (**Since v1.0**, advanced API, called when you update the peer of exit span.)
