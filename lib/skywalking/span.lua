    ...
    if contextCarrier ~= nil then
        ...
        if propagatedContext ~= nil then
            ...
            if ref ~= nil then
                ...
                TC_Internal.addRefIfFirst(context.internal, ref)
...
function Span:new(operationName, context, parent)
    ...
    o.span_id = TC_Internal.nextSpanID(context.internal)
    ...
    TC_Internal.addActive(context.internal, o)
...
function Span:finish(endTime)
    ...
    TC_Internal.finishSpan(self.owner.internal, self)
